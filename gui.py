...
class GUI(object):
     def __init__(self):
          ...
          img = ImageTk.PhotoImage(Image.open("spr/map1.png"))
          img2 = ImageTk.PhotoImage(Image.open("spr/map2.png"))
          img3 = ImageTk.PhotoImage(Image.open("spr/map3.png"))
          self.map.create_image(175,100, image=img)
          self.map2.create_image(175,100, image=img2)
          self.map3.create_image(175,100, image=img3)
