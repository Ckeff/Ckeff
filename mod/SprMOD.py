...
class spr_BEAM(pygame.sprite.Sprite): #Sprite class for the big laser on level 3 (ironically also houses the functionality for some reason)
    def __init__(self, screen_size): #Constructor for the beam's sprite class, takes screen size as a parameter to determine where the center of the screen is
        ...
        self.image_old = [pygame.image.load(os.path.join('spr','beam.png')).convert_alpha(), 
                          pygame.image.load(os.path.join('spr','beam2.png')).convert_alpha(), 
                          pygame.image.load(os.path.join('spr','beam3.png')).convert_alpha(), 
                          pygame.image.load(os.path.join('spr','beam4.png')).convert_alpha(), 
                          pygame.image.load(os.path.join('spr','beam5.png')).convert_alpha(), 
                          pygame.image.load(os.path.join('spr','beam6.png')).convert_alpha(), 
                          pygame.image.load(os.path.join('spr','beam2.png')).convert_alpha()] #Sets the sprite image
...
class spr_Player1(pygame.sprite.Sprite):
    def __init__(self): #Constructor
        pygame.sprite.Sprite.__init__(self)
        self.i = 1
        self.spr = [pygame.image.load(os.path.join('spr','P1_0.png')).convert_alpha(), 
                    pygame.image.load(os.path.join('spr','P1_1.png')).convert_alpha(), 
                    pygame.image.load(os.path.join('spr','P1_2.png')).convert_alpha(), 
                    pygame.image.load(os.path.join('spr','P1_3.png')).convert_alpha(), 
                    pygame.image.load(os.path.join('spr','P1_4.png')).convert_alpha(), 
                    pygame.image.load(os.path.join('spr','P1_5.png')).convert_alpha(), 
                    pygame.image.load(os.path.join('spr','P1_6.png')).convert_alpha(), 
                    pygame.image.load(os.path.join('spr','P1_7.png')).convert_alpha(), 
                    pygame.image.load(os.path.join('spr','P1_8.png')).convert_alpha(), 
                    pygame.image.load(os.path.join('spr','P1_9.png')).convert_alpha(), 
                    pygame.image.load(os.path.join('spr','P1_10.png')).convert_alpha(), 
                    pygame.image.load(os.path.join('spr','P1_11.png')).convert_alpha(), 
                    pygame.image.load(os.path.join('spr','P1_12.png')).convert_alpha(), 
                    pygame.image.load(os.path.join('spr','P1_13.png')).convert_alpha(), 
                    pygame.image.load(os.path.join('spr','P1_14.png')).convert_alpha(), 
                    pygame.image.load(os.path.join('spr','P1_15.png')).convert_alpha(), 
                    pygame.image.load(os.path.join('spr','P1_16.png')).convert_alpha(), 
                    pygame.image.load(os.path.join('spr','P1_17.png')).convert_alpha()] #Loads the player sprite
...
class spr_Player2(spr_Player1): #Player 2's sprite attribute, with functions inherited from Player 1's sprite attributes
    def __init__(self): #Constructor similar to Player 1's innit, loads different image 
        pygame.sprite.Sprite.__init__(self) 
        self.i = 1
        self.spr = [pygame.image.load(os.path.join('spr','P2_0.png')).convert_alpha(), 
                    pygame.image.load(os.path.join('spr','P2_1.png')).convert_alpha(), 
                    pygame.image.load(os.path.join('spr','P2_2.png')).convert_alpha(), 
                    pygame.image.load(os.path.join('spr','P2_3.png')).convert_alpha(), 
                    pygame.image.load(os.path.join('spr','P2_4.png')).convert_alpha(), 
                    pygame.image.load(os.path.join('spr','P2_5.png')).convert_alpha(), 
                    pygame.image.load(os.path.join('spr','P2_6.png')).convert_alpha(), 
                    pygame.image.load(os.path.join('spr','P2_7.png')).convert_alpha(), 
                    pygame.image.load(os.path.join('spr','P2_8.png')).convert_alpha(), 
                    pygame.image.load(os.path.join('spr','P2_9.png')).convert_alpha(), 
                    pygame.image.load(os.path.join('spr','P2_10.png')).convert_alpha(), 
                    pygame.image.load(os.path.join('spr','P2_11.png')).convert_alpha(), 
                    pygame.image.load(os.path.join('spr','P2_12.png')).convert_alpha(), 
                    pygame.image.load(os.path.join('spr','P2_13.png')).convert_alpha(), 
                    pygame.image.load(os.path.join('spr','P2_14.png')).convert_alpha(), 
                    pygame.image.load(os.path.join('spr','P2_15.png')).convert_alpha(), 
                    pygame.image.load(os.path.join('spr','P2_16.png')).convert_alpha(), 
                    pygame.image.load(os.path.join('spr','P2_17.png')).convert_alpha()] #Loads the player sprite
        self.spr_len = len(self.spr) - 2
        self.image = self.spr[self.i]
