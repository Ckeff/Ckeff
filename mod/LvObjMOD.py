...
class Teleporter:
    def __init__(self, color, T_num, T_pos): #Constructor
        ...
        self.spr = [pygame.image.load(os.path.join('spr','teleporter_'+sprite_name[0])).convert_alpha(), 
                    pygame.image.load(os.path.join('spr','teleporter_'+sprite_name[1])).convert_alpha()]
