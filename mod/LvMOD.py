...
Player_1.init_player(1, gui.player1) #Inits player 1 specific data
Player_2.init_player(2, gui.player2) #Inits player 2 specific data
...
class Level:
    ...
    def Lvl_3(self): #Satellites level
        ...
        Player_1.init_player(1, gui.player1) #Inits player 1 specific data
        Player_2.init_player(2, gui.player1) #Inits player 2 specific data
