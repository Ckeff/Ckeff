...
class Screen:
    def __init__(self, lvlnum): #Constructor
        ...
        if lvlnum == 1: #Load Background
            ...
            self.BG = [pygame.image.load('spr\BG.png').convert(), 
                       pygame.image.load('spr\BG2.png').convert(), 
                       pygame.image.load('spr\BG3.png').convert(), 
                       pygame.image.load('spr\BG4.png').convert(), 
                       pygame.image.load('spr\BG5.png').convert()]
            self.BG2 = [0]
        elif lvlnum == 2:
            self.animation_speed = 14
            self.BG = [pygame.image.load('spr\BG22_1.png').convert(), 
                       pygame.image.load('spr\BG22_1.png').convert(), 
                       pygame.image.load('spr\BG22_1.png').convert(), 
                       pygame.image.load('spr\BG22_2.png').convert(), 
                       pygame.image.load('spr\BG22_3.png').convert(), 
                       pygame.image.load('spr\BG22_4.png').convert(), 
                       pygame.image.load('spr\BG22_5.png').convert(), 
                       pygame.image.load('spr\BG22_5.png').convert(), 
                       pygame.image.load('spr\BG22_5.png').convert()]
            self.BG2 = [0]
            ...
            self.BG = [pygame.image.load('spr\BG31_1.png').convert_alpha(), 
                       pygame.image.load('spr\BG31_1.png').convert_alpha(), 
                       pygame.image.load('spr\BG31_2.png').convert_alpha(), 
                       pygame.image.load('spr\BG31_3.png').convert_alpha(), 
                       pygame.image.load('spr\BG32_1.png').convert_alpha(), 
                       pygame.image.load('spr\BG32_2.png').convert_alpha(), 
                       pygame.image.load('spr\BG32_3.png').convert_alpha(), 
                       pygame.image.load('spr\BG33_1.png').convert_alpha(), 
                       pygame.image.load('spr\BG33_2.png').convert_alpha(), 
                       pygame.image.load('spr\BG33_3.png').convert_alpha(), 
                       pygame.image.load('spr\BG33_3.png').convert_alpha()]
            self.BG2 = [pygame.image.load('spr\stars.png').convert(), 
                        pygame.image.load('spr\stars.png').convert(), 
                        pygame.image.load('spr\stars2.png').convert(), 
                        pygame.image.load('spr\stars3.png').convert(), 
                        pygame.image.load('spr\stars4.png').convert(), 
                        pygame.image.load('spr\stars4.png').convert()]
